...
export function DecisionTreeDiagram({ caption }: { caption?: string }) {
  return (
    ...
    >
      <svg viewBox="0 0 260 150" className="w-full min-w-[220px] h-auto" aria-hidden>
        <rect x={95} y={8} width={70} height={24} rx={4} fill={c.accentDim} stroke={c.accent} strokeWidth={1} />
        <text x={130} y={24} textAnchor="middle" fill={c.textBright} fontSize={8} fontFamily="system-ui">
          x₁ &lt; 0.5?
        </text>
        ...
        <text x={70} y={70} textAnchor="middle" fill={c.textBright} fontSize={7} fontFamily="system-ui">
          Class A
        </text>
        <rect x={145} y={55} width={70} height={22} rx={4} fill={c.negativeDim} stroke={c.negative} strokeWidth={1} />
        <text x={180} y={70} textAnchor="middle" fill={c.textBright} fontSize={7} fontFamily="system-ui">
          x₂ &lt; 1?
        </text>
        ...
        <text x={137} y={114} textAnchor="middle" fill={c.textBright} fontSize={7} fontFamily="system-ui">
          A
        </text>
        <rect x={185} y={100} width={55} height={20} rx={3} fill={c.negativeDim} stroke={c.negative} strokeWidth={1} />
        <text x={212} y={114} textAnchor="middle" fill={c.textBright} fontSize={7} fontFamily="system-ui">
          B
        </text>
        <text x={55} y={42} fill={c.text} fontSize={7} fontFamily="system-ui">
          Yes
        </text>
        <text x={168} y={42} fill={c.text} fontSize={7} fontFamily="system-ui">
          No
        </text>
      </svg>
    </VisualFigure>
